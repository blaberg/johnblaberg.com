...
const Resume = () => {
  return (
    <Layout pageTitle="Resume">
      <h2 className="font-bold text-3xl mb-6">Educational Experience</h2>
      ...
      <h2 className="font-bold text-3xl mt-12 mb-6">Work Experience</h2>
      <div className="grid grid-cols-2 gap-x-12 gap-y-6 text-lg">
        <div className="font-semibold">
          <h3>Summer Intern</h3>
          <p>Einride</p>
        ...
        <ul className="list-disc font-serif">
          <li>Part of the IT-Team with a focus on automation and security.</li>
          <li>I implemented automatic backups for all production databases.</li>
          <li>
        ...
        <ul className="list-disc font-serif">
          ...
          <li>
            Interacted with analysts from international investment- banks, such
            as UBS, Deutsche Bank, Credit Suisse, and Morgan Stanley.
          </li>
        </ul>
        <div className="font-semibold">
        ...
        <ul className="list-disc font-serif">
          ...
          <li>
            I was responsible for every part of the process, from first contact
